...
const BOARD = [
  { name: 'شروع', type: 'go' },
  { name: 'خیابان مدیترانه', type: 'property', group: 'brown', price: 60, mortgage: 30, houseCost: 50, rent: [2, 10, 30, 90, 160, 250] },
  { name: 'صندوق مشترک', type: 'chest' },
  { name: 'خیابان بالتیک', type: 'property', group: 'brown', price: 60, mortgage: 30, houseCost: 50, rent: [4, 20, 60, 180, 320, 450] },
  { name: 'مالیات بر درآمد', type: 'tax', amount: 200 },
  { name: 'راه‌آهن ریدینگ', type: 'railroad', group: 'railroad', price: 200, mortgage: 100 },
  { name: 'خیابان شرقی', type: 'property', group: 'lightblue', price: 100, mortgage: 50, houseCost: 50, rent: [6, 30, 90, 270, 400, 550] },
  { name: 'شانس', type: 'chance' },
  { name: 'خیابان ورمانت', type: 'property', group: 'lightblue', price: 100, mortgage: 50, houseCost: 50, rent: [6, 30, 90, 270, 400, 550] },
  { name: 'خیابان کنتیکت', type: 'property', group: 'lightblue', price: 120, mortgage: 60, houseCost: 50, rent: [8, 40, 100, 300, 450, 600] },
  { name: 'زندان / بازدید', type: 'jail' },
  { name: 'میدان سنت چارلز', type: 'property', group: 'pink', price: 140, mortgage: 70, houseCost: 100, rent: [10, 50, 150, 450, 625, 750] },
  { name: 'شرکت برق', type: 'utility', group: 'utility', price: 150, mortgage: 75 },
  { name: 'خیابان ایالتی', type: 'property', group: 'pink', price: 140, mortgage: 70, houseCost: 100, rent: [10, 50, 150, 450, 625, 750] },
  { name: 'خیابان ویرجینیا', type: 'property', group: 'pink', price: 160, mortgage: 80, houseCost: 100, rent: [12, 60, 180, 500, 700, 900] },
  { name: 'راه‌آهن پنسیلوانیا', type: 'railroad', group: 'railroad', price: 200, mortgage: 100 },
  { name: 'میدان سنت جیمز', type: 'property', group: 'orange', price: 180, mortgage: 90, houseCost: 100, rent: [14, 70, 200, 550, 750, 950] },
  { name: 'صندوق مشترک', type: 'chest' },
  { name: 'خیابان تنسی', type: 'property', group: 'orange', price: 180, mortgage: 90, houseCost: 100, rent: [14, 70, 200, 550, 750, 950] },
  { name: 'خیابان نیویورک', type: 'property', group: 'orange', price: 200, mortgage: 100, houseCost: 100, rent: [16, 80, 220, 600, 800, 1000] },
  { name: 'پارکینگ رایگان', type: 'freeparking' },
  { name: 'خیابان کنتاکی', type: 'property', group: 'red', price: 220, mortgage: 110, houseCost: 150, rent: [18, 90, 250, 700, 875, 1050] },
  { name: 'شانس', type: 'chance' },
  { name: 'خیابان ایندیانا', type: 'property', group: 'red', price: 220, mortgage: 110, houseCost: 150, rent: [18, 90, 250, 700, 875, 1050] },
  { name: 'خیابان ایلینوی', type: 'property', group: 'red', price: 240, mortgage: 120, houseCost: 150, rent: [20, 100, 300, 750, 925, 1100] },
  { name: 'راه‌آهن B&O', type: 'railroad', group: 'railroad', price: 200, mortgage: 100 },
  { name: 'خیابان آتلانتیک', type: 'property', group: 'yellow', price: 260, mortgage: 130, houseCost: 150, rent: [22, 110, 330, 800, 975, 1150] },
  { name: 'خیابان ونتنور', type: 'property', group: 'yellow', price: 260, mortgage: 130, houseCost: 150, rent: [22, 110, 330, 800, 975, 1150] },
  { name: 'تأسیسات آب', type: 'utility', group: 'utility', price: 150, mortgage: 75 },
  { name: 'باغ‌های ماروین', type: 'property', group: 'yellow', price: 280, mortgage: 140, houseCost: 150, rent: [24, 120, 360, 850, 1025, 1200] },
  { name: 'برو به زندان', type: 'gotojail' },
  { name: 'خیابان پاسیفیک', type: 'property', group: 'green', price: 300, mortgage: 150, houseCost: 200, rent: [26, 130, 390, 900, 1100, 1275] },
  { name: 'خیابان کارولینای شمالی', type: 'property', group: 'green', price: 300, mortgage: 150, houseCost: 200, rent: [26, 130, 390, 900, 1100, 1275] },
  { name: 'صندوق مشترک', type: 'chest' },
  { name: 'خیابان پنسیلوانیا', type: 'property', group: 'green', price: 320, mortgage: 160, houseCost: 200, rent: [28, 150, 450, 1000, 1200, 1400] },
  { name: 'خط کوتاه', type: 'railroad', group: 'railroad', price: 200, mortgage: 100 },
  { name: 'شانس', type: 'chance' },
  { name: 'پارک پلیس', type: 'property', group: 'darkblue', price: 350, mortgage: 175, houseCost: 200, rent: [35, 175, 500, 1100, 1300, 1500] },
  { name: 'مالیات تجملات', type: 'tax', amount: 100 },
  { name: 'بوردواک', type: 'property', group: 'darkblue', price: 400, mortgage: 200, houseCost: 200, rent: [50, 200, 600, 1400, 1700, 2000] },
];
...
const CHANCE = [
  ...
  { text: 'به خیابان ایلینوی برو.', action: 'move:24' },
  { text: 'به میدان سنت چارلز برو.', action: 'move:11' },
  ...
  { text: 'سفری به راه‌آهن ریدینگ برو.', action: 'move:5' },
  { text: 'به بوردواک برو.', action: 'move:39' },
